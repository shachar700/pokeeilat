...
{
    [MAPSEC_HAIFA_CITY] = {MAP_GROUP(HAIFA_CITY), MAP_NUM(HAIFA_CITY), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_HAIFA_CITY; mapSecId <= MAPSEC_EVER_GRANDE_CITY; mapSecId++)
    {

static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(HAIFA_CITY), MAP_NUM(HAIFA_CITY), 20, 39},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(HAIFA_CITY), MAP_NUM(HAIFA_CITY), 20, 39},

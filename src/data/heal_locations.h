static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(HAIFA_CITY), MAP_NUM(HAIFA_CITY), 5, 9},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(HAIFA_CITY), MAP_NUM(HAIFA_CITY), 14, 9},
